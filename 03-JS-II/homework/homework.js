...
function fizzBuzz(numero) {
  ...
  if ( Number.isInteger(n1) && Number.isInteger(n2)) {return 'fizzbuzz';} 
  if (Number.isInteger(n1))  {return 'fizz';}
  if (Number.isInteger(n2))  {return 'buzz';}
  return numero;
