...
function mesesDelAño(array) {
  ...
  var vM = [];
  for (var i= 0; i< array.length; i++){
    if (array[i].includes('Enero') || array[i].includes('Marzo') || array[i].includes('Noviembre')  ) vM.push(array [i])
  }
  if (vM.length == 3) return vM;
...
function mayorACien(array) {
  ...
  // Tu código:
  const result = array.filter ( num1 => num1 > 100) ;
  return result;
}
